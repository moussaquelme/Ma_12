...
df = pd.read_csv('Z Parameter Plot 300.csv', sep=',', header=None)

hf = pd.read_csv('Z Parameter Plot 320.csv', sep=',', header=None)
#print(df)
...
print('Zload and Zload_2=', Z_Load[1],Z_Load_2[i])
""" neu""" 
...
def Quarter_Wave(Z_l,Z_l_2): 
    ...
    print('Characteristic impedance =', Z_0, Z_0_2)
...
Quarter_Wave(Z_Load, Z_Load_2)
print('Shape of Z_in =', Z_in.shape, Z_in_2.shape)
