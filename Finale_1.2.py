...
#ax3=ax2.twinx()
ax2.plot(x,Z_output_imag ,'r')
ax2.set_title('Zin_real vs frequency')
ax2.set_xlabel('Frequency in [Hz]')
ax2.set_ylabel('Zin_Impedanz real and imaginary [Ohm]')

ax3.plot(x,Z_output_1 ,'b')
ax3.set_title('Z_in vs frequency')
ax3.set_xlabel('Frequency in [Hz]')
ax3.set_ylabel('Zin_Impedanz in [Ohm]')
